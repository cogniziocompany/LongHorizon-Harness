...
**Decision:** CT 106 `cognizioware-pihole2` (cognizioware-pihole2.lan.easybutt0n.ai) on corsairai300 (192.168.21.151), static 192.168.21.4/24 (verified free: no ping/ARP), upstreams 1.1.1.1 + 8.8.8.8, config teleported from the primary. DHCP on the router hands out 192.168.21.3 then 192.168.21.4.
