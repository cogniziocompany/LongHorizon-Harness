...
- 2026-09-07 17:00 PT: eval-flakiness run 3f931e9b delivered (34416bc infra classifier + retry + exit 3; 1167615 QA maxIterations 35 + tightened multistep prompts). PR #86 merged to develop; the develop CI restarts the dev tier stack so n8n re-imports eval-micro-run.json at startup (N8N_WORKFLOW_IMPORT_PATH). Next: re-run the develop promotion once the CI is green; watch for exit-3 infra blocks vs real regressions.
