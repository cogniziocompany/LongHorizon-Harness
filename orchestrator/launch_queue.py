...
BASE="http://192.168.21.168:8799"; TOKEN="f8bd96ca638dc8da40d8bd8617f4140a0fd533e6019afd81"
...
_SEQ=[0]   # monotonic launch counter - see the 04:05 note at the call site
def _trio(i):
...
while True:
    ...
    for f in q:
        ...
        try:
            ...
            _SEQ[0]+=1   # advance the rotation ONLY on a real launch, so held tasks do not skip trios
